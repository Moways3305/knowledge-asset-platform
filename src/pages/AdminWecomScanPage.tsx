...
export default function AdminWecomScanPage() {
  ...
  // 创建 / 编辑表单状态（PBC-10A）。editingId=null 表示新建。
        ...
        <section className="ws-section">
          <div className="ws-detail-panel">
            ...
            <div className="ws-form-grid">
              ...
              <label className="ws-form-field">
                <span className="ws-form-label">微盘目录内部标识</span>
                <input className="ws-form-input" value={fDir} onChange={(e) => setFDir(e.target.value)} placeholder="spaceid:<id>;fatherid:<id>" />
                <span className="ws-form-hint">企微微盘目录的服务端内部标识，格式 <code>spaceid:&lt;id&gt;;fatherid:&lt;id&gt;</code>；fatherid 省略表示根目录。</span>
              </label>
              <label className="ws-form-field">
